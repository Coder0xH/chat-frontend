...
var useCompositeRow = createHook(
  function useCompositeRow2(_a) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime.jsx)(CompositeRowContext.Provider, { value: providerValue, children: element }),
      [providerValue]
    );
...
var useSelect = createHook(function useSelect2(_a) {
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime2.jsx)(SelectScopedContextProvider, { value: store, children: element }),
    [store]
  );
  const [autofill, setAutofill] = (0, import_react2.useState)(false);
  const nativeSelectChangedRef = (0, import_react2.useRef)(false);
          ...
          "select",
          {
            ...
            children: [
              toArray(value).map((value2) => {
                ...
                return (0, import_jsx_runtime2.jsx)("option", { value: value2, children: value2 }, value2);
              }),
              values.map((value2) => (0, import_jsx_runtime2.jsx)("option", { value: value2, children: value2 }, value2))
            ]
          }
        ),
        element
  ...
  const children = (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    value,
    (0, import_jsx_runtime2.jsx)(SelectArrow, {})
  ] });
...
function SelectProvider(props = {}) {
  ...
  return (0, import_jsx_runtime3.jsx)(SelectContextProvider, { value: store, children: props.children });
}
...
var useSelectHeading = createHook(
  function useSelectHeading2(props) {
    const [, setHeadingId] = (0, import_react3.useContext)(SelectHeadingContext) || [];
    const id = useId(props.id);
    useSafeLayoutEffect(() => {
...
var useSelectItemCheck = createHook(
  function useSelectItemCheck2(_a) {
    ...
    const context = (0, import_react4.useContext)(SelectItemCheckedContext);
...
var useSelectItem = createHook(
  function useSelectItem2(_a) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime4.jsx)(SelectItemCheckedContext.Provider, { value: selected != null ? selected : false, children: element }),
      [selected]
    );
    props = __spreadProps(__spreadValues({
      id,
...
var TagName11 = "div";
var SelectListContext = (0, import_react6.createContext)(null);
var useSelectList = createHook(
  function useSelectList2(_a) {
    ...
    const value = store.useState("value");
    const multiSelectable = Array.isArray(value);
    const [defaultValue2, setDefaultValue] = (0, import_react6.useState)(value);
    ...
    const headingContext = (0, import_react6.useContext)(SelectHeadingContext);
    const headingState = (0, import_react6.useState)();
    const [headingId, setHeadingId] = headingContext || headingState;
    const headingContextValue = (0, import_react6.useMemo)(
      () => [headingId, setHeadingId],
      [headingId]
    );
    const [childStore, setChildStore] = (0, import_react6.useState)(null);
    const setStore = (0, import_react6.useContext)(SelectListContext);
    (0, import_react6.useEffect)(() => {
      if (!setStore) return;
      setStore(store);
    ...
    props = useWrapElement(
      props,
      (element2) => (0, import_jsx_runtime5.jsx)(SelectScopedContextProvider, { value: store, children: (0, import_jsx_runtime5.jsx)(SelectListContext.Provider, { value: setChildStore, children: (0, import_jsx_runtime5.jsx)(SelectHeadingContext.Provider, { value: headingContextValue, children: element2 }) }) }),
...
//# sourceMappingURL=chunk-RIMXCOJE.js.map
