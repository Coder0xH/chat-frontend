...
} from "./chunk-Q7DG4WCR.js";
import "./chunk-BDYPGRRS.js";
import "./chunk-OKVIWUFT.js";
import "./chunk-TNNUGND3.js";
import "./chunk-KYYPVRER.js";
import "./chunk-2WYY4LMX.js";
import "./chunk-BNWTBMTE.js";
import "./chunk-DR6TWGIA.js";
import "./chunk-SQ35FXDD.js";
import "./chunk-4O5VMWIK.js";
import "./chunk-RIUPYTUS.js";
import "./chunk-BBI2KK46.js";
import {
  require_stream_browserify
} from "./chunk-HNIGWWNV.js";
import "./chunk-5RRHITN5.js";
import "./chunk-ST2SSYQ4.js";
import {
  __commonJS,
  __esm,
  __export,
...
var import_dist, ws, browser_default;
...
// ../node_modules/msedge-tts/dist/OUTPUT_FORMAT.js
var require_OUTPUT_FORMAT = __commonJS({
  "../node_modules/msedge-tts/dist/OUTPUT_FORMAT.js"(exports) {
    "use strict";
    var import_dist3 = __toESM(require_dist());
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OUTPUT_FORMAT = void 0;
    var OUTPUT_FORMAT;
    (function(OUTPUT_FORMAT2) {
...
var require_MsEdgeTTS = __commonJS({
  "../node_modules/msedge-tts/dist/MsEdgeTTS.js"(exports) {
    "use strict";
    var import_dist3 = __toESM(require_dist());
    ...
    var stream = __importStar(require_stream_browserify());
    var isomorphic_ws_1 = __importDefault((init_browser(), __toCommonJS(browser_exports)));
    var buffer_1 = require_buffer_polyfill();
    var crypto_1 = require_crypto_browserify();
    var OUTPUT_FORMAT_1 = require_OUTPUT_FORMAT();
    ...
    var MsEdgeTTS = class _MsEdgeTTS {
      /**
      ...
      _initClient() {
        this._ws = this._isBrowser ? new isomorphic_ws_1.default(_MsEdgeTTS.SYNTH_URL) : new isomorphic_ws_1.default(_MsEdgeTTS.SYNTH_URL, { agent: this._agent });
...
\r
      ...
      cacheAudioData(m, requestId) {
        const index = m.indexOf(_MsEdgeTTS.BINARY_DELIM) + _MsEdgeTTS.BINARY_DELIM.length;
      ...
      _SSMLTemplate(input, options = new ProsodyOptions()) {
      ...
      _rawSSMLRequestToFile(path, requestSSML) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
          const stream2 = this._rawSSMLRequest(requestSSML);
          const chunks = [];
          stream2.on("data", (data) => chunks.push(data));
          stream2.once("close", () => __awaiter(this, void 0, void 0, function* () {
            if (Object.keys(this._queue).length > 0 && chunks.length === 0) {
              reject("No audio data received");
            }
            const output = fs.createWriteStream(path);
            while (chunks.length > 0) {
              yield new Promise((resolve2) => output.write(chunks.shift(), resolve2));
            }
            resolve(path);
          }));
        }));
...
// ../node_modules/msedge-tts/dist/PITCH.js
var require_PITCH = __commonJS({
  "../node_modules/msedge-tts/dist/PITCH.js"(exports) {
    "use strict";
    var import_dist3 = __toESM(require_dist());
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../node_modules/msedge-tts/dist/RATE.js
var require_RATE = __commonJS({
  "../node_modules/msedge-tts/dist/RATE.js"(exports) {
    "use strict";
    var import_dist3 = __toESM(require_dist());
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.RATE = void 0;
...
// ../node_modules/msedge-tts/dist/VOLUME.js
var require_VOLUME = __commonJS({
  "../node_modules/msedge-tts/dist/VOLUME.js"(exports) {
    "use strict";
    var import_dist3 = __toESM(require_dist());
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_dist2 = __commonJS({
  "../node_modules/msedge-tts/dist/index.js"(exports) {
    var import_dist3 = __toESM(require_dist());
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.VOLUME = exports.RATE = exports.PITCH = exports.OUTPUT_FORMAT = exports.ProsodyOptions = exports.MsEdgeTTS = void 0;
    var MsEdgeTTS_1 = require_MsEdgeTTS();
    Object.defineProperty(exports, "MsEdgeTTS", { enumerable: true, get: function() {
      return MsEdgeTTS_1.MsEdgeTTS;
    } });
    Object.defineProperty(exports, "ProsodyOptions", { enumerable: true, get: function() {
      return MsEdgeTTS_1.ProsodyOptions;
    } });
    var OUTPUT_FORMAT_1 = require_OUTPUT_FORMAT();
    Object.defineProperty(exports, "OUTPUT_FORMAT", { enumerable: true, get: function() {
      return OUTPUT_FORMAT_1.OUTPUT_FORMAT;
    } });
    var PITCH_1 = require_PITCH();
    Object.defineProperty(exports, "PITCH", { enumerable: true, get: function() {
      return PITCH_1.PITCH;
    } });
    var RATE_1 = require_RATE();
    Object.defineProperty(exports, "RATE", { enumerable: true, get: function() {
      return RATE_1.RATE;
    } });
...
//# sourceMappingURL=msedge-tts.js.map
